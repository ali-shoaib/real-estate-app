...
const Property = ({ property: { coverPhoto, price, rentFrequency, rooms, title, baths, area, agency, isVerified, externalID  } }) => (
    <Link href={`/property/${externalID}`} passHref>
        ...
        borderRadius='10px'>
            <Box>
                <Image src={coverPhoto ? coverPhoto.url : DefaultImage} width={400} height={260} alt="coverphoto" />
            </Box>
            <Box w='full'>
                ...
                <Flex alignItems='center' p='1' justifyContent='space-between' w='250px' color='red.700'>
